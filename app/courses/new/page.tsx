          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="overflow-hidden rounded-sm border border-slate-300">
                <div className="flex flex-wrap items-center gap-3 border-b border-slate-200 bg-[#f8fafc] px-3 py-2 text-xs text-slate-600">
        ...
        <div className="space-y-4 rounded-sm bg-white p-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative h-6 w-11 rounded-full transition ${featured ? "bg-blue-500" : "bg-slate-300"
                }`}
            >
              <span
                className={`absolute top-0.5 h-5 w-5 rounded-full bg-white transition ${featured ? "left-5" : "left-0.5"
                  }`}
              />
            </button>
          </div>
          ...
          <div>
            ...
            <div className="rounded-sm border border-slate-300 p-2">
              ...
              <button className="mt-3 inline-flex items-center gap-1 text-xs text-blue-600 hover:text-blue-700">

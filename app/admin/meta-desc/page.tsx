...
type ModalType = null | "addMeta" | "editMeta" | "deleteMeta";
...
export default function MetaDescPage() {
  ...
  const openDeleteModal = (item: MetaItem) => {
    setSelectedItem(item);
    setModal("deleteMeta");
  };
      ...
      >
        <div className="space-y-4">
          <p className="text-sm text-gray-600">
            Are you sure you want to delete this meta record?
          </p>
